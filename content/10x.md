...
Một cách khác nữa, là dùng [non-greedy](https://docs.python.org/3/howto/regex.html#greedy-versus-non-greedy) `.+?:.+?:`. `.+` bình thường sẽ match
nhiều nhất có thể, thì khi thêm `?` sau nó, nó sẽ match ít nhất có thể.
