...
Các pwn thủ, rev thủ toàn dùng [IDA Pro](https://hex-rays.com/ida-pro/) bản trả tiền, [Ninja](https://binary.ninja/) hàng xịn, bấm một nút là biến asm thành code C ngay (ahuhu vẫn phải đọc code C), hàng free như Ghidra hay radare2 nhiều khi không xịn bằng, chứ đừng nói tới dump code Assembly rồi đọc chay.
