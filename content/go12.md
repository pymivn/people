...
tạo ra 1 giá trị trong Go, giá trị đó sẽ được chứa trong 1 ô, sử dụng phép toán [`&` (address operator)](https://golang.org/ref/spec#Address_operators) sẽ lấy được địa chỉ này là một số int > 0 biểu diễn ở dạng hex.
